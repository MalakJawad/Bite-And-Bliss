    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              SizedBox(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Row(children: [
                    IconButton(
                        onPressed: () => _handleSocial(context, 'Instagram'),
                        icon: const Icon(Icons.camera_alt, color: AppColors.primaryForeground)),
                    IconButton(
                        onPressed: () => _handleSocial(context, 'Facebook'),
                        icon: const Icon(Icons.facebook, color: AppColors.primaryForeground)),
                    IconButton(
                        onPressed: () => _handleSocial(context, 'Twitter'),
                        icon: const Icon(Icons.alternate_email, color: AppColors.primaryForeground)),
                  ]),
                ]),
              ),
              SizedBox(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  const Text('Quick Links',
                      style: TextStyle(color: AppColors.primaryForeground, fontWeight: FontWeight.bold)),
          ...
          const SizedBox(height: 12),
          const Text('© 2024 Bite & Bliss. All rights reserved. Made with ❤️ for food lovers.',
