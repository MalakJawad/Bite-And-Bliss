...
class MenuSection extends StatelessWidget {
    ...
    switch (name) {
      case 'Appetizers':
        return [
          ...
          {'name': 'Nuggets (6 pieces)', 'desc': 'Served with cocktail sauce', 'image': 'assets/nuggets.jpeg', 'price': '\$4'},
      ...
      case 'Pizza & Mains':
        return [
          {'name': 'Margherita Pizza', 'desc': '', 'image': 'assets/plain.jpg', 'price': '\$10'},
          {'name': 'Chicken Alfredo Pizza', 'desc': '', 'image': 'assets/alfredo.jpg', 'price': '\$14'},
          {'name': 'Peperoni Pizza', 'desc': '', 'image': 'assets/pep.jpg', 'price': '\$12'},
      ...
      case 'Drinks':
        return [
          ...
          {'name': 'Pepsi', 'desc': 'Bottle 2\$ / Can 1\$', 'image': null, 'price': '\$2'},
          {'name': 'Miranda', 'desc': 'Bottle 2\$ / Can 1\$', 'image': null, 'price': '\$2'},
          {'name': '7 Up', 'desc': 'Bottle 2\$ / Can 1\$', 'image': null, 'price': '\$2'},
          {'name': 'Diet', 'desc': 'Bottle 2\$ / Can 1\$', 'image': null, 'price': '\$2'},
      ...
      case 'Desserts':
        return [
          {'name': 'Chocolate Cake', 'desc': '', 'image': 'assets/choco.jpg', 'price': '\$5'},
          {'name': 'Tiramisu', 'desc': '', 'image': 'assets/tiramisu.png', 'price': '\$6'},
  ...
  void _onCategoryTap(BuildContext context, String name) {
    ...
    if (items.isEmpty) {
      showToast(context,
          title: '$name Selected',
          description: 'Full menu coming soon!');
      return;
    }
